...
# is not caught here — ~/.claude/rules/dbguard-destructive-ops.md is the
...
if echo "$cmd" | grep -qiE \
  ...
  echo "Follow the db-guard investigation-first workflow (~/.claude/rules/dbguard-destructive-ops.md):" >&2
  echo "" >&2
